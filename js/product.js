(function () {
  ...
  var changeProductOrderInfo = function (target) {
    ...
    order
      .querySelector(".order-info__title")
      .setAttribute("value", productTitle);
    order.querySelector(".order-info__size").setAttribute("value", productSize);
    order
      .querySelector(".order-info__price")
      .setAttribute("value", productPrice);

    order.querySelector(".order-product__title").textContent = productTitle;
    order.querySelector(".order-product__price").textContent = productPrice;
